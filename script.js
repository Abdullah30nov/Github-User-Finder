...
async function getUser(username) {
    try {
        main.innerHTML = `<div class="spinner-border" role="status">
...
//     userdata.innerHTML = `<div class="spinner-border" role="status">
//   <span class="visually-hidden">Loading...</span>
// </div>`
...
//         console.log(json)
// //         userdata.innerHTML = `<div class="card" style="width: 18rem;">
